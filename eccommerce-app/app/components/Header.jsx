      ...
      <div className="lg:hidden fixed top-0 left-0 right-0 z-30 bg-[var(--bg-secondary)]/90 backdrop-blur-md border-b border-[var(--border-color)] shadow-md">
        <div className="px-4 py-3 flex items-center justify-between">
          ...
          <button
            ...
            className="w-10 h-10 bg-[var(--text-primary)] border border-[var(--border-color)] rounded-xl flex flex-col justify-center items-center gap-[4px] active:scale-95 transition-transform shrink-0"
